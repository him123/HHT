...
//				createDialogWithoutDateField().show();
                ...
                DatePickerDialog dpd = new DatePickerDialog(MyCalendarActivity.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
                    public void onDateSet(DatePicker view, int year1, int monthOfYear, int dayOfMonth) {
                        ...
                        String s = months[monthOfYear] + "  " + year1;
    ...
    public class GridCellAdapter extends BaseAdapter implements OnClickListener {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            tv_event = (TextView) row.findViewById(R.id.num_events_per_day);
            // ACCOUNT FOR SPACING
            ...
            if (theday.equals("2") && themonth.equals("December") || theday.equals("4")) {
                tv_event.setText("E");
            } else {
                tv_event.setText("");
            }
